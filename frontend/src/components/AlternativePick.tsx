...
interface AlternativePickProps {
  productName: string;
  productDescription: string;
  onExpand?: () => void;
}

const AlternativePick: React.FC<AlternativePickProps> = ({ 
  productName, 
  productDescription,
  onExpand 
}) => {
  ...
  return (
    <div 
      className="relative w-full border-black border-[3px] border-solid rounded-[16px] bg-white p-4 min-h-[100px]"
...
export default AlternativePick;
