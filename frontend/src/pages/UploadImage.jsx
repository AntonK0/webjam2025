    ...
    <>
      ...
      <div className=' h-screen'>
        <div className='pt-6 mt-20' >
          <h1 className="text-3xl font-bold text-black mx-12">Let's see what we're working with.</h1>
        </div>
        <h2 className="text-lg text-gray-600 mx-12 mt-4">Take a picture of the product aisle.
